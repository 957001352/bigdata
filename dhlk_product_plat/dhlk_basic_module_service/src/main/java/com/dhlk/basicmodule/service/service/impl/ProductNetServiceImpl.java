...
public class ProductNetServiceImpl implements ProductNetService {
    ...
    public Result findList(String name, Integer type) {
        return ResultUtils.success(productNetDao.findList(name, type));
    }

    @Override
    public Result findBiList(Integer netId) {
        return ResultUtils.success(productNetDao.findBiList(netId));
    }

    @Override
    public Result findComputerList(Integer netId) {
        return ResultUtils.success(productNetDao.findProductList(netId));
    }


    @Override
    public Result findNotBiList() {
        return ResultUtils.success(productNetDao.findNotBiList());
    }

    @Override
    public Result findNotComputerList() {
        return ResultUtils.success(productNetDao.findNotProductList());
    }
}
